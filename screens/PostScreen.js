...
export default class PostScreen extends Component {
  ...
  async initiateTTS(title, post, moral) {
    console.log(title)
    ...
    if (current_color === "gray") {
      Speech.speak(title);
      Speech.speak(post);
      Speech.speak("The moral of the post is!");
      Speech.speak(moral);
    } else {
      Speech.stop();
    }
          ...
          <View style={styles.storyContainer}>
            ...
            >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.initiateTTS(
                        ...
                        this.props.route.params.post.value.moral
                      )
                    }
                  >
                    <Ionicons
              ...
              <View style={styles.postTextContainer}>
                ...
                >
                  Moral - {this.props.route.params.post.value.moral}
                </Text>
              </View>
